...
export default function JobListScreen() {
  ...
  const SearchBarComponent = memo(() => (
    <View style={[styles.searchContainer, { paddingTop: Spacing.lg, paddingBottom: Spacing.md, paddingHorizontal: Spacing.xl, backgroundColor: colors.backgroundDefault }]}>
      <View
        style={[
          styles.searchBox,
          {
      ...
      >
        <View style={[styles.modalOverlay, { justifyContent: "flex-end" }]}>
          <KeyboardAvoidingView
            ...
            style={{ flex: 1 }}
          >
            <View style={[styles.modalContent, { backgroundColor: theme.backgroundRoot, flex: 1, maxHeight: "95%", flexDirection: "column", paddingTop: insets.top + Spacing.lg }]}>
              {/* Modal Header */}
